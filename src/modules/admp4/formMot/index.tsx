...
import { FormCadMot } from "../../../components/componentesMot";
import { MyDrawer } from "../../../components/layout/drawer";

interface IFormMotPrincipal {
    onOpen: () => void;
    onClose: () => void;
}

export const FormCadMotMain: React.FC<IFormMotPrincipal> = () => {
