...
import { FormCadVtr } from "../../../components/componentesFormVtr";

interface IFormCadVtr {
    onOpen: () => void;
    onClose: () => void;
}

export const FormCadVtrMain: React.FC<IFormCadVtr> = () => {
